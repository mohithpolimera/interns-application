...
if(isset($_POST['submit']))
{
    ...
    $role=$_POST['role'];
    $sql="insert into kmrlform(name,email,designation,role) values('$name', '$email','$designation','$role')";
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-8 col-lg-6 col-xl-9 offset-xl-1">
          <div class="divider d-flex align-items-center my-4">
            <h3 class="text-center fw-bold mx-3 mb-0">Admin Portal</h3>
          </div>
          <div data-mdb-input-init class="form-outline mb-4">
          <div id="tabs">

        <ul>
            <li><a href="#tabs-1">HR</a></li>
        ...
        <div id="tabs-1">
                ...
                <p>
                <?php
                $sql = "SELECT COUNT(*) AS total FROM kmrlform";
                $result = $conn->query($sql);
            ...
            $sql1 = "SELECT name,email,designation FROM kmrlform where role='hr' LIMIT $start_from, $limit";
            ...
            while($row =$result1->fetch_assoc() ){
                ...
                $html .="<td><a href='validate2.php?email=".$em."'>Delete</a></td></tr>";
                break;
            }
            while($row =$result1->fetch_assoc() ){
                $html .="<tr>";
        ...
        ?>
            ...
            <a href='admin1.php'>Add a New User</a>
                </p>
            </div>
            </div>
            <div data-mdb-input-init class="form-outline mb-4">
            <div  id="tabs-2">
                ...
                $start_from = ($page - 1) * $limit;
                $total_pages = ceil($total_records / $limit);
            $sql1 = "SELECT name,email,designation FROM kmrlform where role='finance' LIMIT $start_from, $limit";
            $result1 = $conn->query($sql1);
            $html = "<table class='paging_table' border='1'>";
            while($row =$result1->fetch_assoc() ){
                $html .="<tr>";
