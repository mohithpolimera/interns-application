...
$sql1="select name from kmrlappform where studentemail = '".$email."' LIMIT 1";
$result1 = $conn->query($sql1);
$row1 =$result1->fetch_assoc();
$name=$row1['name'];
$sql="select status from kmrlappform where studentemail = '".$email."' LIMIT 1";
    ...
    <div class="col-md-9 col-lg-6 col-xl-5">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          ...
          <div class="row align-items-center py-3">
              ...
              <div class="col-md-10 pe-9">
                <?php
                if($row['status']=='verified')
                {
                    echo "Your Payment Details are verified Successfully";
                    echo "Finance Approval Status is Verified";
                    echo "Congratulations,you are selected for internship.<br>refer your email for further details";
                }
                else if($row['status']=='')
                {
                    echo "Your Payment details are under Verification";
                    echo "Please wait until Finance Approval";
                }
                else if($row['status']=='notverified')
                {
                    echo "Your Payment is not successfull as per given utr number";
                    echo "check if you have uploaded right utr number or not then correct them and apply once again";
                }
                ?>
</center>
              </div>
